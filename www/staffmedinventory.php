...
<body>
    <div class="sidebar" id="mySidebar">
        ...
        <a href="staffmedinventory.php" class="active">MedInventory</a>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="inventory-card">
                        ...
                        <form action="staffmedinventory.php" method="POST" class="mb-5">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <form action="staffmedinventory.php" method="POST" class="form-inline d-inline mr-2" onsubmit="return confirm('Are you sure you want to dispense this medicine?');">
    ...
    <div class="modal fade" id="editMedicineModal" tabindex="-1" role="dialog" aria-labelledby="editMedicineModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="staffmedinventory.php" method="POST">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="staffmedinventory.php" method="POST" class="d-inline">
