...
<head>
    ...
    <style>
        ...
        .container-fluid {
            ...
            padding: 20px;
            margin-top: 80px; /* Leave space for the header */
...
<body>
    <div class="sidebar" id="mySidebar">
        ...
        <a href="staffaddpatient.php" class="active">Add Patient</a>
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" action="staffadd_patient_backend.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Sex" required pattern="[MmFf]" title="Enter 'M' or 'F'">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="ContactNumber" pattern="[0-9]{11}" title="Enter a valid 11-digit number" required>
                                <label>Emergency Number</label>
                                <input type="tel" class="form-control" name="emergency_number" pattern="[0-9]{11}" title="Enter a valid 11-digit number">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="height" required min="0" step="0.01">
    ...
    <script>
        document.querySelector("form").addEventListener("submit", function(e) {
            ...
            fetch("staffadd_patient_backend.php", { // Changed action to staffadd_patient_backend.php
                method: "POST",
                body: formData
            })
