    ...
    <div class="main-content" id="mainContent">
        ...
        <?php else: ?>
            <div class="card mb-4 printable-area">
                ...
                <div class="card-body">
                    <form method="POST" id="bulkDeleteForm" onsubmit="return confirm('Are you sure you want to delete the selected consultation records?');">
                                ...
                                <tbody>
                                    ...
                                    if ($consultationsResult && $consultationsResult->num_rows > 0) {
                                        while ($record = $consultationsResult->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "<td><input type='checkbox' name='delete_ids[]' value='" . htmlspecialchars($record['ConsultationID']) . "'></td>";
