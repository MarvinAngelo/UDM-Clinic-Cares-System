...
<body>
    <div class="sidebar" id="mySidebar">
        ...
        <a href="medilog.php" class="active">Medical Logs</a>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        <button type="button" class="btn btn-danger btn-sm"
                                                ...
                                                data-delete-id="<?php echo htmlspecialchars($log['ConsultationID']); ?>"
                                                data-current-date="<?php echo htmlspecialchars($currentDate); ?>">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="13" class="text-center">No medical logs found for this date.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" id="deleteForm">
                        ...
                        <input type="hidden" name="current_date" id="modal_current_date">
...
<button class="chatbot-button" onclick="toggleChatbotPopover()">Ask UDM Cora?</button>
    ...
    <script>
        ...
        // Populate modal with data when it's about to be shown
        $('#deleteConfirmationModal').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var deleteId = button.data('delete-id'); // Extract info from data-* attributes
            var currentDate = button.data('current-date');

            var modal = $(this);
            modal.find('#modal_delete_id').val(deleteId);
            modal.find('#modal_current_date').val(currentDate);
        });
